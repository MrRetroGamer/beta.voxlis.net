const expData = [
  ...
  },
  {
    ...
    period: "lifetime",
    plat: ["windows"],
    pros: ["External", "Driver based", "Features a decompiler and code explorer", "Undetected", "Fast updates"],
    neutral: ["Updates have to be manually downloaded", "Lua environment WIP"],
    cons: ["Can be difficult to setup if you dont follow the provided steps and read FAQ's"],
    verified: false,
    editor: "sk337",
    txtColor: "text-green-500",
    accentColor: "from-green-600 to-green-700",
  ...
  },
  {
    ...
    free: true,
    warning: true,
    warningInfo: "Was made to steal user data in 2021",
  },
  {
    id: "nezur",
    name: "Nezur",
...
const updCnts = () => {
  if (els.fltCnt) {
    animateCounter(els.fltCnt, Number.parseInt(els.fltCnt.textContent) || 0, st.fltrd.length)
  }
  if (els.ttlCnt) {
    animateCounter(els.ttlCnt, Number.parseInt(els.ttlCnt.textContent) || 0, expData.length)
  }
}
